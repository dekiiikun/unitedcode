...
##########################################
# c0ded by : Deki T.r.I | Toekang Tikung #
##########################################
...
a_sslx(){
    ...
    echo \# PORT LISTEN 443 BY DekiTr :v >> /etc/apache2/ports.conf
...
a_samba(){
	clear
 	...
 	echo \#SAMBA SERVER CONFIGURATION FILE BY DekiTr >> /etc/samba/smb.conf
...
a_asterisk(){
	 ...
	 sleep 1
	 clear
	 echo \# ASTERISK FILE CONFIGURATION BY DekiTr >> /etc/asterisk/sip.conf
	 echo \# ASTERISK FILE CONFIGURATION BY DekiTr >> /etc/asterisk/extensions.conf
...
if [[ $dvd1 != "" && $dvd2 != "" && $dvd3 != ""  ]]; then
	...
	if [[ `pwd` == "/repo" ]]; then
	    ...
	    if [[ "$regex_urlx" -eq "0" ]]; then
	    	...
	    	echo "#Repository Created by DekiTr kun <3"
	    else
	    	clear
	    	echo "#--------- YOUR NEW REPOSITORY ----------"
...
a_main(){
		clear    	
echo "LLLLLLLLLLL               iiii                                                          "
echo "L:::::::::L              i::::i                                                         "
echo "L:::::::::L               iiii                                                          "
echo "LL:::::::LL                                                                             "
echo "  L:::::L               iiiiiiinnnn  nnnnnnnn    uuuuuu    uuuuuu  xxxxxxx      xxxxxxx "
echo "  L:::::L               i:::::in:::nn::::::::nn  u::::u    u::::u   x:::::x    x:::::x  "
echo "  L:::::L                i::::in::::::::::::::nn u::::u    u::::u    x:::::x  x:::::x   "
echo "  L:::::L                i::::inn:::::::::::::::nu::::u    u::::u     x:::::xx:::::x    "
echo "  L:::::L                i::::i  n:::::nnnn:::::nu::::u    u::::u      x::::::::::x     "
echo "  L:::::L                i::::i  n::::n    n::::nu::::u    u::::u       x::::::::x      "
echo "  L:::::L                i::::i  n::::n    n::::nu::::u    u::::u       x::::::::x      "
echo "  L:::::L         LLLLLL i::::i  n::::n    n::::nu:::::uuuu:::::u      x::::::::::x     "
echo "LL:::::::LLLLLLLLL:::::Li::::::i n::::n    n::::nu:::::::::::::::uu   x:::::xx:::::x    "
echo "L::::::::::::::::::::::Li::::::i n::::n    n::::n u:::::::::::::::u  x:::::x  x:::::x   "
echo "L::::::::::::::::::::::Li::::::i n::::n    n::::n  uu::::::::uu:::u x:::::x    x:::::x  "
echo "LLLLLLLLLLLLLLLLLLLLLLLLiiiiiiii nnnnnn    nnnnnn    uuuuuuuu  uuuuxxxxxxx      xxxxxxx "             
...
echo -e -n $m  "DekiTr"$k"@"$b"smkn2kalianda$n : "
read pil
if [[ $pil == "1" ]]; then
	a_confnet
	a_main
